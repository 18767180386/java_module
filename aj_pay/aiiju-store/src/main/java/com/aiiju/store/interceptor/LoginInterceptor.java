...
public class LoginInterceptor implements HandlerInterceptor {
	...
	private static String[] filterUrls = { "/sso", "/erp", "/note", "/shop", "/user/inviteUI", "/user/inviteUser",
			...
			"/product/downloadAndroid", "/reputation", "/paCallback", "/user/heartBeat", "/priceTag/createPriceTag","bookingManage/getBookingManageById",
			"/scrm/getScrmGrant","/scrm/updateUnwrapScrm"};
