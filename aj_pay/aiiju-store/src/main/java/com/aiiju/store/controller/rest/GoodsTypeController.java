...
public class GoodsTypeController {
	...
	@ResponseBody
	public Result getRelationParentGoodsList(String parentStoreId,String storeId,  String keyWord,String goodsTypeId,
		...
		try {
			return this.goodsTypeService.getRelationParentGoodsList(parentStoreId,storeId,keyWord,goodsTypeId,pageSize, pageNum);
		} catch (Exception e) {
			logger.error(e.getMessage());
			return Result.build(500,WebConstant.SYS_ERROR);
		}
