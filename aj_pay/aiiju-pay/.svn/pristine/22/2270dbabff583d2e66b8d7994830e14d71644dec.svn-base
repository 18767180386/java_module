package com.aiiju.pay.business.wx.protocol.pay_protocol;
...
/**
 * 
 * @ClassName: PayReqData 
 * @Description: 统一下单 请求
 * @author 小飞 
 * @date 2016年12月8日 下午6:44:28 
 *
 */
public class PayReqData {
    ...
    public PayReqData(String subMchId,String notify_url,String trade_type,String openId,String product_id,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag) {
