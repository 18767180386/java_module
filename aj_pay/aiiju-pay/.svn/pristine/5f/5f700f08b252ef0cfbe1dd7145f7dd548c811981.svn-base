...
public class ApiService implements BeanFactoryAware {
     ...
     * @throws IOException
     */
    public Result doPost(String url, Map<String, String> params) throws IOException {
        // 创建http POST请求
        ...
        try {
            ...
            return Result.build(response.getStatusLine().getStatusCode(), EntityUtils.toString(
