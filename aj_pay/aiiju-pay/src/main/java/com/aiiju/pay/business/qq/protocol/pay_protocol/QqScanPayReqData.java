...
/**
 * 
 * @ClassName: QqScanPayReqData 
 * @Description: 付款码 请求
 * @author 小飞 
 * @date 2017年2月7日 下午4:34:14 
 *
 */
public class QqScanPayReqData {
    ...
    public QqScanPayReqData(String subMchId,String authCode,String notity_url,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP){

        //qq钱包支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
