package com.aiiju.pay.business.wx.protocol.pay_query_protocol;
...
/**
 * 
 * @ClassName: ScanPayQueryReqData 
 * @Description: 扫描支付查询请求
 * @author 小飞 
 * @date 2016年12月7日 下午3:58:52 
 *
 */
public class ScanPayQueryReqData {
     ...
     * @throws Exception
     */
    public ScanPayQueryReqData(String subMchId,String transactionID, String outTradeNo){
